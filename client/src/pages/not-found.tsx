...
export default function NotFound() {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-slate-950 px-4">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(59,130,246,0.3),transparent_35%),radial-gradient(circle_at_85%_0%,rgba(20,184,166,0.2),transparent_30%),linear-gradient(180deg,#050b1d_0%,#040916_100%)]" />
